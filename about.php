		...
		<div class="container">
			<div class="row p-b-148">
				<div class="col-md-7 col-lg-8">
					<div class="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
						...
						<p class="stext-113 cl6 p-b-26">
							Perfumes Online Store is a family-owned and operated perfume retail company that has been in business since 2001. We have been working hard to offer high-end products to our valued customers both domestically and internationally. We carry authentic perfumes from designers, exclusive perfumes, private labels, and hard-to-find perfumes, colognes and related gifts for men, women, and children that cannot be found locally. Perfumes Online Store strives to be elegant, persistent, bold, knowledgeable, and multilingual to offer the best perfumes and customer service to our valuable clientele, which we believe sets us apart from the competition.
						</p>

						<p class="stext-113 cl6 p-b-26">
							Also, Perfumes Online Store identifies each perfume with color-coded tabs, origin, and ingredients to be transparent and honest about the perfumes and products we offer.‍
						</p>

						<p class="stext-113 cl6 p-b-26">
							Any questions? Let us know by calling +1(800)123-6879
						</p>
					</div>
				</div>
				...
				<div class="col-11 col-md-5 col-lg-4 m-lr-auto">
					<div class="how-bor1 ">
						<div class="hov-img0">
							<img src="images/store2.jpg" alt="IMG">
						</div>
					</div>
				</div>
			</div>
